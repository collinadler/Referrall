//
//  CPAOnboardingContentViewController.m
//  Referrall
//
...
@interface CPAOnboardingContentViewController ()

@end

@implementation CPAOnboardingContentViewController
...
+ (instancetype)contentWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    CPAOnboardingContentViewController *contentVC = [[self alloc] initWithTitle:title body:body image:image buttonText:buttonText action:action];
    return contentVC;
}
